...
As a designer with skills in developing at Vector Etch, I embarked on a mission to transform our manufacturing operations.
Our existing processes, although detailed and structured, relied heavily on cumbersome tools like Google Docs and Sheets.
...
This full-stack web application, powered by Ruby on Rails, offers effective order and stock management solutions.
